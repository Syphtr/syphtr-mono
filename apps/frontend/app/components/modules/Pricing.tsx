          ...
          <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
            ...
            <ul className="mb-8 space-y-4 text-left">
              <li className="flex items-center space-x-3">
                ...
                <span>Your first step to building the talent pool you have always dreamed of</span>
              </li>
              <li className="flex items-center space-x-3">
                <svg
                  className="flex-shrink-0 w-5 h-5 text-green-500 dark:text-green-400"
          ...
          <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
            ...
            <ul className="mb-8 space-y-4 text-left">
              ...
              <li className="flex items-center space-x-3">
                ...
                <span>Curated, handpicked and guaranteed to meet your brief - Not a random list of profiles from a professional networking search</span>
              </li>
              <li className="flex items-center space-x-3">
                <svg
                  className="flex-shrink-0 w-5 h-5 text-green-500 dark:text-green-400"
              ...
              <li className="flex items-center space-x-3">
                ...
                <span>
                  Each Talent Pipeline is set up for one job/project but we can change the paramaters/briefing with a little notice!
                </span>
              </li>
            </ul>
            <a
  ...
  <span className="text-gray-500 dark:text-gray-400">/screened and introduced candidate + plus relevant hiring fees (see below)</span>
            ...
            <ul className="mb-8 space-y-4 text-left">
              ...
              <li className="flex items-center space-x-3">
                ...
                <span>
                  Stop paying if the candiate we helped you to hire leaves (or after 36 months, whichever comes first)
                </span>
              </li>
              <li className="flex items-center space-x-3">
                <svg
                ...
                <span>
                  Easy subscription payments and no hidden fees
                </span>
              </li>
              <li className="flex items-center space-x-3">
                <svg
                ...
                <span>
                  Take cotroll of your hiring costs today!
                </span>
              </li>
            </ul>
            <a
