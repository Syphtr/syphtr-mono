        ...
        <div className="grid gap-16 items-center lg:grid-cols-2 lg:py-16 lg:px-6">
          ...
          <div className="lg:col-span-3">
            <div className="font-bold text-gray-500 sm:text-lg dark:text-gray-400">
              ...
              <p className="mb-4 text-gray-400">
                Our specialism is sourcing/hiring GTM/Revenue generating teams (Sales, Pre-Sales, Business Development
              ...
              <ul className="text-gray-400">
                ...
                <li className="text-gray-400">- Database Management Systems (DBMS)</li>
              </ul>
            </div>
          </div>
          ...
          <div className="lg:col-span-3">
            <div className="font-bold text-gray-500 sm:text-lg dark:text-gray-400">
              ...
              <p className="mb-4 text-gray-400">
                Syphtr's proprietary sourcing/filtering/scoring software can do 7 days worth of sourcing in roughly 3 hours. With access to the most powerful sourcing tools available, and a team of sourcing/research experts who are trained to use these tools to their full potential, Syphtr will provide you with a constant flow of well-matched candidates on autopilot.
                ...
                Being a member also means you have access to our Talent Pool SaaS (coming soon) - meaning you can keep all of your sourced candidates in one place and use our advanced filtering and matching tools to keep track of your talent for the long  term. 
              </p>
            </div>
          </div>
          <div className="lg:col-span-2">
          ...
          <div className="lg:col-span-3">
            <div className="font-bold text-gray-500 sm:text-lg dark:text-gray-400">
              <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-400 dark:text-gray-300">
                How do you quantify the quality of your candidates and how can you find/provide so many per month?
              </h2>
              <p className="mb-4 text-gray-400">
                We are lucky enough to have access to the most advanced sourcing tools available for GTM hiring. These tools are developed and created by Syphtr and they allow us to accurately filter/find candidates whilst also extracting vital data points to provide a report card for every candidate we source for you. These report cards contain data points relating to things like the total percentage of career spent in competitive companies, the percentage of career spent in stable/successful roles (Stable/successful tenure defined by you), and an overall score based on combinations of these.
          ...
          <div className="lg:col-span-3">
            <div className="font-bold text-gray-500 sm:text-lg dark:text-gray-400">
              ...
              <p className="mb-4 text-gray-400">
                Our candidate data is sourced from multiple ptoviders. We have access to over 55m candidate records across the UK and many European countries. We have partnerships with public data providers and we combine this with proprietary data sets that we have manually created.
